...
parser.add_argument("iwu", help = 'ipWebcam URL, i.e. \'http://192.168.58.253:8080/video\'', nargs='?', default='http://192.168.58.253:8080/video')
...
try:
  ...
  print('Error opening ipWebcam URL: ', args.iwu)
